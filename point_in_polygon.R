library(readr)
library(tidyverse)
measurements <- read_csv("~/Documents/Projects/offline/measurements.csv")
...
one_day_tmp <- one_day[1:10, ]
bench
one_day
one_day$zoneid <- apply(one_day, 1, function(x) find_zone(x[40], x[41]))
